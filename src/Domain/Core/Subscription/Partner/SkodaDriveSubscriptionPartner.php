...
class SkodaDriveSubscriptionPartner implements SubscriptionPartnerInterface
{
    public const PARTNER_ID = 2;
    public const BRAND_ID = 57;
    ...
    private const LEAD_EMAIL = 'carl_leads@belkacar.ru';
    ...
    public function loadData(): void
    {
        ...
        foreach ($data as $modelData) {
            ...
            if (!$subModel) {
                ...
                if (!$brand || !$model) {
                    $this->logger->error("For partner Skoda Drive model {$modelData['model']} not found");
                    continue;
                }
