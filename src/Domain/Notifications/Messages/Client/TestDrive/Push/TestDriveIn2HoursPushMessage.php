...
/**
 * Пуш-уведомление клиенту о том, что до тест-драйва осталось два часа
 */
final class TestDriveIn2HoursPushMessage extends AbstractPushMessage
{
    private const TITLE = 'client.test_drive.in_2_hours.title';
    private const TEXT = 'client.test_drive.in_2_hours.text';
